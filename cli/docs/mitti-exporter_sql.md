...
Export Mitti data to SQL database

```
mitti-exporter sql [flags]
```
...
```
  ...
  -h, --help                                help for sql
      ...
      --site-include-full-hierarchy         Include full sites hierarchy in table e.g. areas, regions, etc (default true) (default true)
